...
// Reaktive Liste für die Benutzer
const users = ref<any[]>([]);
const { channel } = useEchoPresence('retro.1', 'NewParticipantEvent', (event) => {
...
onMounted(() => {
    ...
    // Initial die aktuelle Liste holen
    presenceChannel.here((currentUsers) => {
        users.value = currentUsers;
    });

    // Wenn jemand joinet, zur Liste hinzufügen
    presenceChannel.joining((user) => {
        users.value.push(user);
    });

    // Wenn jemand geht, aus der Liste entfernen
