...
class SitemapsControllerTest < ActionDispatch::IntegrationTest
  test "sitemap includes key public pages" do
    untenanted do
      ...
      assert_in_body alternative_quickretro_url(script_name: nil)
      assert_in_body alternative_reetro_url(script_name: nil)
      assert_in_body alternative_funretro_url(script_name: nil)
