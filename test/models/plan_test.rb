...
class PlanTest < ActiveSupport::TestCase
  ...
  test "price_for_display raises when paid plan has no stripe price id" do
    plan = Plan.new(key: :custom, name: "Custom", price: 9.99, retro_limit: Float::INFINITY)
  ...
  test "price_for_display raises when stripe api key is missing" do
    plan = Plan.new(key: :custom, name: "Custom", price: 9.99, retro_limit: Float::INFINITY, stripe_price_id: "price_test_123")
