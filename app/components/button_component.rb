class ButtonComponent < ApplicationComponent
  BASE_CLASSES = "group relative inline-flex items-center justify-center font-ui font-bold uppercase tracking-widest transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed border-[2px] rounded-pill"
