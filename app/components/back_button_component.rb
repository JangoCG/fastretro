class BackButtonComponent < ApplicationComponent
  ...
  def default_back_button
    link_to @href, class: "group inline-flex items-center gap-2 font-ui text-xs sm:text-sm font-bold uppercase hover:bg-black hover:text-white px-2 sm:px-3 py-1.5 sm:py-2 transition-colors border border-transparent hover:border-black", data: hotkey_data do
      safe_join([
